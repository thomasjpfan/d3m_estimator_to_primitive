...
class D3M_XGBRegressor(
    SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]
):
    """
    Primitive wrapping for xgboost.XGBRegressor
    """
    ...
    metadata = metadata_base.PrimitiveMetadata(
        {
            ...
            "python_path": "d3m.primitives.classification.xgboost.XGBRegressor",
            "version": "2021.3.0",
            "id": "b7d9f6b2-78d8-373e-b3b0-c614e118bfdd",
...
D3M_XGBRegressor.__doc__ = XGBRegressor
